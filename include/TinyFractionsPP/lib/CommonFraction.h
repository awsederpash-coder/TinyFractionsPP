...
inline fr::CommonFraction fr::CommonFraction::operator*(const CommonFraction &other) const noexcept {
    return {m_num*other.m_num, static_cast<int64>(m_denom*other.m_denom)};
}

inline fr::CommonFraction fr::CommonFraction::operator*(int64 x) const noexcept {
    return {m_num*x,static_cast<int64>(m_denom)};
}

inline fr::CommonFraction fr::CommonFraction::operator*(double x) const noexcept {
    return *this * CommonFraction(x);
}
...
inline fr::CommonFraction fr::CommonFraction::operator/(int64 x) const noexcept {
    return {m_num, static_cast<int64>(m_denom)*x};
}
